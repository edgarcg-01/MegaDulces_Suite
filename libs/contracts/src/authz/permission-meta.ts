...
export const PERMISSION_META: Record<string, PermissionMetaEntry> = {
  ...
  [Permission.COMMERCIAL_TICKETS_VER]: { label: 'Ver Tickets de venta', description: 'Buscar cualquier folio de venta (ticket de mostrador, telemarketing, credito o pedido propio) y reimprimirlo en formato ticket o carta, con el descuento desglosado. Solo lectura: no altera nada en el ERP.', category: 'Comercial' },
  ...
  [Permission.FINANCE_RECEIVABLES_VER]: { label: 'Ver Crédito de clientes', description: 'Módulo Cartera / Partidas vivas: estado de cuenta CxC read-only de Kepler (kdue) — saldo, vencido y aging por cliente, con drill al auxiliar por documento.', category: 'Finanzas' },
  ...
  [Permission.FINANCE_PAYMENTS_VER]: { label: 'Ver Pagos a Proveedor (comprobantes)', description: 'Módulo Pagos: lista de pagos a proveedor de Kepler (XD2501), adjuntar el comprobante de transferencia (imagen/PDF), correr OCR y ver el cuadre de monto. También gatea el Calendario de Pagos y los Compromisos financieros (Fase TP).', category: 'Finanzas' },
  [Permission.FINANCE_PAYMENTS_GESTIONAR]: { label: 'Gestionar Pagos a Proveedor', description: 'Validar o rechazar los comprobantes de transferencia adjuntados a los pagos. También asigna/reprograma/prepara pagos en el Calendario de Pagos y autoriza Compromisos financieros (Fase TP).', category: 'Finanzas' },
  [Permission.FINANCE_PAYMENT_CALENDAR_AUTORIZAR]: { label: 'Autorizar Calendario de Pagos', description: 'Libera el lote de pagos del día (separado de quien lo prepara) y aprueba/rechaza cambios de cuenta bancaria de proveedor. Permiso restringido — no lo incluye "Gestionar Pagos a Proveedor".', category: 'Finanzas' },
  [Permission.FINANCE_CAJA_VER]: { label: 'Ver Caja General', description: 'Modulo Caja General: libro de ingresos y egresos de efectivo, arqueo por denominacion y saldo corrido. La plataforma es la fuente principal del efectivo (Fase CG).', category: 'Finanzas' },
  [Permission.FINANCE_CAJA_GESTIONAR]: { label: 'Capturar en Caja General', description: 'Registrar fichas de efectivo, comprobantes de gasto y depositos, con su cuenta y concepto de Kepler. NO autoriza el corte.', category: 'Finanzas' },
  [Permission.FINANCE_CAJA_AUTORIZAR]: { label: 'Autorizar corte de Caja General', description: 'Cierra y autoriza el corte de caja (separado de quien captura) y confirma el mapa de cuentas hacia el concepto de Kepler. Permiso restringido -- no lo incluye "Capturar en Caja General".', category: 'Finanzas' },
