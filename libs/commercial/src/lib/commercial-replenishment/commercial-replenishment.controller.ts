...
export class CommercialReplenishmentController {
  ...
  @RequireAnyPermission(
    Permission.COMPRAS_PEDIDO_VER, Permission.COMPRAS_REQUISICIONES_VER, Permission.COMPRAS_ORDENES_VER,
    Permission.COMPRAS_HALLAZGOS_VER, Permission.COMPRAS_PROVEEDORES_VER, Permission.COMPRAS_CATEGORIAS_VER,
    Permission.COMPRAS_RED_VER, Permission.COMPRAS_DESCUENTOS_VER,
  )
  ...
  @Get('categories')
  @RequirePermissions(Permission.COMPRAS_CATEGORIAS_VER)
  ...
  @RequirePermissions(Permission.COMPRAS_CATEGORIAS_GESTIONAR)
  ...
  @Get('network')
  @RequirePermissions(Permission.COMPRAS_RED_VER)
  ...
  @RequirePermissions(Permission.COMPRAS_RED_GESTIONAR)
