...
- ALMACENES/SUCURSALES (código → nombre → apodo de piso, en el ORDEN en que se muestran): 01 Padre Hidalgo "PH" (surte al portal/vendedor) · MD-30 Morelia Abastos "MA" · MD-32 Morelia Madero "MM" · 03 8ESQ "8ES" · 02 La Piedad Abastos "LPA" · 04 Yurécuaro "YU" · 06 Canindo "CAN" · 05 Zamora Centro "DAMASO" · 00 CEDIS BPIRAPUATO "CEDIS". ⚠️ El almacén 00 es el CEDIS de verdad (bodegón Irapuato, su existencia sale de WINCAJA); la sucursal 00 DE KEPLER es OFICINAS y no vende — no son lo mismo. Las RUTAS también se modelan como "almacén" (RUTA-21…RUTA-505). Si el usuario nombra un almacén por apodo o con typo, resolvé con thot_resolve_entity / thot_list_warehouses.
