 ...
 * avanzada (PU.4, escenarios/copia/comparación/import idempotente/proyección de cierre).
 ...
 */
@Module({
  controllers: [BudgetLinesController, BudgetComparisonController, BudgetPlanningController],
  providers: [BudgetLinesService, BudgetComparisonService, BudgetCashflowService, BudgetPlanningService],
  exports: [BudgetLinesService, BudgetComparisonService, BudgetCashflowService, BudgetPlanningService],
})
