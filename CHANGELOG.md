...
- **Pendiente prod:** aplicar las 3 migraciones + `node database/tests/test-newdb-erp-sales-invoices.js` + redeploy api/view. Diferidos: AX.5 (agente de impresión por WebSocket), AX.6 (IA), AX.7 (control de pagarés). Plan en [`FASE_AX_ANEXO_VENTA.md`](docs/IMPLEMENTACION/FASES/FASE_AX_ANEXO_VENTA.md).
