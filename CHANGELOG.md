...
**Contraseñas de las 6 altas:** una distinta por tienda, aleatoria y sin caracteres ambiguos porque se teclean en un kiosco; **no se imprimen ni entran a git** (archivo fuera del repo), y el script las verifica con **prueba negativa** — el hash acepta la generada y rechaza otra. `must_change_password = false` con motivo: es credencial de puesto, y forzar el cambio deja al resto del turno afuera.
