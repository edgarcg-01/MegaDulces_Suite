...
- **Estado de prod:** el rol quedó **aplicado** (batch 341, en los 2 tenants — sólo hace INSERTs y `RowExclusive` no choca con el respaldo); la **columna sigue pendiente** (se rindió a los 3 s, limpio) y se reaplica al terminar el dump. Después: `--apply` por sucursal + redeploy del api.
