...
> **Estado:** 🟢 MVP CONSTRUIDO (beta local) · 2026-08-21 · **CXC.0–5 ✅** · builds api+view verde · saldo **cuadra al peso vs el PDF real** + **drill exacto cobro→factura (kdm5)**. Commits `0825f91f` (data+backend) · `c9ffc47e` (frontend) · `0b07d01f` (grupo/zona) · `eb4bfb47` (drill kdm5).
