...
> **Estado:** 🟢 CONSTRUIDO (beta local) · 2026-08-21 · **CXC.0–9 ✅** · builds api+view verde · saldo cuadra al peso vs PDF + drill exacto (kdm5) + **valor agregado (límite/gerencial/riesgo/contacto/360)**. Commits: `0825f91f` `c9ffc47e` `0b07d01f` `eb4bfb47` (MVP) · `d0e0394e` (CXC.6+8) · `5c07a0ea` (CXC.7) · `c9efa7b6` (CXC.9).
