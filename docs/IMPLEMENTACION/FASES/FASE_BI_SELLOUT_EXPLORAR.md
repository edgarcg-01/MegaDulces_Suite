...
>
> **Estado: BI.0 ✅ (prod+.245, `17b7e07a`) · BI.3 (`961c95db`) · BI.5 (`7475fc7a`) · BI.2 (`1185f573`) · BI.6 (`b75d411d`) · BI.4 (`75606743`) · BI.1 🔨 EN CÓDIGO (Δ MoM + sparkline en KPI) — todo 🔨 sin desplegar. BI.7 (drill a doc, cobertura parcial) / BI.8 (pivote) / BI.9 (objetivos, BLOQUEADO sin fuente) ⬜.**
