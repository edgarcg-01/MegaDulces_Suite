...
### Tres reglas destiladas de la auditoría de `/compras/pedido` (2026-09-14) — BINDING
...
🔸 **Lo que este barrido NO cerró:** el **spinner** y el **teclado de columna** siguen siendo por componente — no hay forma global honesta de decidir cuál campo es una columna de captura y cuál un filtro suelto. Barrido pendiente, ahora acotado a esos dos.
