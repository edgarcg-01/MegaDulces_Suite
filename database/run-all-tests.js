...
const TESTS = [
  ...
  { file: 'test-newdb-user-roles.js', label: 'ID.13 un usuario varios roles (user_roles RLS forzado + índice parcial un-solo-perfil-base + kind/expires_at con CHECK + backfill alineado a role_name + trigger bidireccional role_name↔perfil base con degradación del anterior + unión de permisos suma exacto + encargada+cajera con UNA cuenta)', needsApi: false },
