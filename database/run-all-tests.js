...
const TESTS = [
  ...
  { file: 'test-newdb-wincaja-unit-audit.js', label: 'U.10.1 Wincaja auditada con la vara de WINCAJA (v_wincaja_unit_audit) — la primera auditoría de unidad que NO toca Kepler. Las tres que existían usaban box_cost, c84/c81 o cost_with_tax, y juzgar un ERP con la vara del otro es lo que fabrica la categoría "por convertir". La premisa, medida: Wincaja NO tiene ambigüedad de unidad — 0 de 46,577 artículos con más de una unidad de venta, 0 de 15,535 SKUs con unidad distinta entre las 3 ramas vivas, factor_venta consistente en 99.92%. El defecto real es UNO y se detecta sin salir de Wincaja: unidad_compra=CJA con factor_venta<=1 es incoherente por sí solo (no se compra una caja de una pieza) — 1,286 SKUs, 338 con existencia, $1,513,977. Candados: NO CIRCULARIDAD (9 fuentes de Kepler prohibidas en la definición de la vista), que los veredictos particionen, que caja_sin_capturar no pase en vacío y viaje con divisor NULL y nunca con 1 de relleno, que unidad_es_caja lleve divisor 1 (es afirmación, no ausencia — lección W1.1), y el LÍMITE declarado: Wincaja no tiene rótulo PAQ, así que pieza-vs-paquete no es decidible ahí dentro. El testigo de dinero (precios.margen_utilidad) se probó y se DESCARTÓ: cuadra 41.8% en sanos vs 51.9% en defectuosos, está invertido', needsApi: false },
