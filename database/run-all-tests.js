...
const TESTS = [
  ...
  { file: 'test-newdb-goods-receipts-scope.js', label: 'RE.13.0 Entradas: alcance por sucursal (fail-closed con alcance vacío) + carril al_dia/rezago sin hueco + días acotados a hoy (fecha futura = 0) + orden antigüedad + por_validar ⊆ con_comprobante + paginación sin traslape + receipt_settings con RLS forzado', needsApi: false },
