...
// `[IDG.1]` Este test BORRA bins y lotes filtrando sólo por warehouse_id. No puede correr contra prod.
require('./_lib/assert-safe-target').assertSafeTarget('test-newdb-bin-locations');
