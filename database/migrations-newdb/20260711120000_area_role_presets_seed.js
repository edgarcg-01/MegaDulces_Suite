...
const MODULE_GROUPS = {
  ...
  compras: ['COMPRAS_PEDIDO_VER', 'COMPRAS_PEDIDO_GESTIONAR', 'COMPRAS_RED_VER', 'COMPRAS_RED_GESTIONAR', 'COMPRAS_REQUISICIONES_VER', 'COMPRAS_REQUISICIONES_GESTIONAR', 'COMPRAS_ORDENES_VER', 'COMPRAS_ORDENES_GESTIONAR', 'COMPRAS_ENTRADAS_VER', 'COMPRAS_ENTRADAS_GESTIONAR', 'COMPRAS_ENTRADAS_VALIDAR', 'COMPRAS_360_VER', 'COMPRAS_COSTO_NETO_VER', 'COMPRAS_DESCUENTOS_VER', 'COMPRAS_DESCUENTOS_GESTIONAR', 'COMPRAS_HALLAZGOS_VER', 'COMPRAS_HALLAZGOS_GESTIONAR', 'COMPRAS_PROVEEDORES_VER', 'COMPRAS_PROVEEDORES_GESTIONAR', 'COMPRAS_CATEGORIAS_VER', 'COMPRAS_CATEGORIAS_GESTIONAR'],
