...
export const MODULE_GROUPS: Record<string, Permission[]> = {
  ...
  compras: [
    ...
    Permission.COMPRAS_ORDENES_VER, Permission.COMPRAS_ORDENES_GESTIONAR,
    Permission.COMPRAS_ENTRADAS_VER, Permission.COMPRAS_ENTRADAS_GESTIONAR,
    Permission.COMPRAS_360_VER, Permission.COMPRAS_COSTO_NETO_VER,
    Permission.COMPRAS_DESCUENTOS_VER, Permission.COMPRAS_DESCUENTOS_GESTIONAR,
