...
export const PERMISSION_META: Record<string, PermissionMetaEntry> = {
  ...
  [Permission.FINANCE_RECEIPTS_VER]: { label: 'Ver Órdenes de Entrada (comprobantes)', description: 'Módulo Entradas: lista de órdenes de entrada de Kepler (X-A-40), adjuntar la remisión/factura del proveedor (imagen/PDF), correr OCR y ver el cuadre de monto.', category: 'Finanzas' },
  [Permission.FINANCE_RECEIPTS_GESTIONAR]: { label: 'Gestionar Órdenes de Entrada', description: 'Validar o rechazar las remisiones/facturas adjuntadas a las órdenes de entrada.', category: 'Finanzas' },
