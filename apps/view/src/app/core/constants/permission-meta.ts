...
export const PERMISSION_META: Record<string, PermissionMetaEntry> = {
  ...
  [Permission.FINANCE_PURCHASE_BOOK_VER]: { label: 'Ver Libro de Compras', description: 'Módulo Libro de Compras: las facturas del mes con su cuadre, el estado del trámite y la póliza que se le entrega a ContPAQi.', category: 'Finanzas' },
  [Permission.FINANCE_PURCHASE_BOOK_GESTIONAR]: { label: 'Gestionar Libro de Compras', description: 'Incluir o excluir facturas del mes, generar el TXT de la póliza y mover el trámite (entregado / aplicado).', category: 'Finanzas' },
