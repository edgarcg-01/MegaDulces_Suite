export enum Permission {
  ...
  // Telemarketing (Fase E; antes "Televenta" / "Remote Manager")
  ...
  // RD.4 — gasto de flota de Ruta Directa. Ver libs/platform-core enum.
  ...
  // BI — sub-modulo "Analisis" (Sell-Out BI). Ver libs/platform-core enum.
  COMMERCIAL_SELLOUT_ANALYSIS_VER = 'COMMERCIAL_SELLOUT_ANALYSIS_VER',
  // BI.9 — capturar/editar metas de venta. Ver libs/platform-core enum.
  ...
  // RD.6 — comisiones de Ruta Directa. Ver libs/platform-core enum.
  ...
  // Existencia — matriz producto × almacén desde el ODS. UN permiso, DOS proyectos (Almacén y
  // Compras), precedente Caducidades. Espejo del enum de libs/platform-core (ahí está el por qué).
  ...
  // `[AUTHZ-HARD.1]` Superficie interna de inteligencia (back-office), separada de las claves que
  // tiene el customer_b2b. Sincronizado con el enum del backend.
  ...
  // Cartera de clientes / Partidas vivas (CXC / ADR-048) — estado de cuenta CxC read-only sobre Kepler.
  ...
  // Permiso especial restringido: validar/rechazar la remisión (NO lo incluye GESTIONAR).
  ...
  // LC (ADR-052) — Libro de Compras: la póliza mensual que se entrega a ContPAQi.
