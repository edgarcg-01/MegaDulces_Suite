      ...
      <div class="card-premium card-flat">
        <p-table [value]="filteredMatches()" styleClass="p-datatable-sm ls-table" [rowHover]="true" [loading]="loading()"
          ...
          <ng-template #body let-m let-expanded="expanded">
            <tr>
              <td><p-button type="button" [icon]="expanded ? 'pi pi-chevron-down' : 'pi pi-chevron-right'" styleClass="p-button-text p-button-sm" [attr.aria-label]="expanded ? 'Ocultar documentos' : 'Ver documentos'" (click)="toggle(m)"></p-button></td>
