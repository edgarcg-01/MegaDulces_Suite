...
import { ComprasService, AdjustmentsSummary, AdjustmentRow, AdjustmentsSupplierRow } from '../compras.service';

type Sev = 'success' | 'info' | 'warn' | 'danger' | 'secondary' | 'contrast';

/**
 * RE.10 — Descuentos y apoyos de compra. Hace VISIBLE lo que el Excel de recepción
 * no veía: los ajustes de compra de Kepler (X-D-40 "Devolución" / X-D-55 "Nota crédito")
 * clasificados por su motivo (`c24`): descuentos / pronto pago / apoyo de marca, más
 * las facturas DUPLICADAS (error de captura). Superficie Operations (PrimeNG denso).
 */
@Component({
    ...
    <div class="surf-page in dx-page">
      ...
      <header class="surf-page-head">
        <div class="surf-page-head-text">
          ...
          <p class="surf-page-sub">Notas de crédito y devoluciones de compra de Kepler (X-D-40 / X-D-55) clasificadas por su motivo: descuentos, apoyos de marca y pronto pago — más las facturas duplicadas que no son descuento.</p>
        </div>
      </header>
  ...
  styles: [`
    ...
    .dx-w-date { width: 5.5rem; } .dx-w-doc { width: 6rem; } .dx-w-cat { width: 9rem; } .dx-w-amt { width: 7rem; }
