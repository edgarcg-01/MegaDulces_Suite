...
import { FinanceMaatModule, FinanceExpenseProofsModule, FinanceBankModule, FinancePolizasModule, FinanceCollectionDepositsModule, FinanceSupplierPaymentProofsModule, FinanceGoodsReceiptProofsModule } from '@megadulces/finance';
