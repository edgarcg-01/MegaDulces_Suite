 ...
 * producto → mismo tono siempre). Copiado literal de
 * apps/portal/src/app/core/util/brand-placeholder.ts (fuente única del
 * lenguaje visual de placeholder en las apps storefront).
 */
const PH_GRADIENTS = [
